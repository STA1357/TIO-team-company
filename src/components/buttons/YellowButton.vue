<template>
  <div>
    ...
    <button type="button" class="learn_btn" data-toggle="modal" data-target="#staticBackdrop">Learn more <span class="line"></span> ></button>

    <!-- Modal -->
    <div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" style="height: auto" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <input type="email" id="email" class="custom-input pr-5" v-model="postEmail" placeholder="Enter your email*"/>
            <div style="text-align: start">
